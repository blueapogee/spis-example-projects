...
- use of NASA Geosynchronous WC environment for surface charging 


For information: the simulation run in approximately 100 minutes in the ONERA/DESP server Auriga (Dell PowerEdge R820, 32 available cores, 192 Go of RAM, 5.4 To), with particle pushing on 4 threads.
